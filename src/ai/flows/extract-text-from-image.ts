...
/**
 * @fileOverview This file defines the Genkit flow for extracting text from an image (OCR).
 *
 * - extractTextFromImage - A function that takes an image data URI and returns the extracted text.
...
const prompt = ai.definePrompt({
  ...
  prompt: `Your task is to act as an Optical Character Recognition (OCR) tool.
Extract all text from the provided image accurately.
Maintain the original line breaks and formatting as much as possible.
Do not interpret, analyze, or summarize the text. Only extract it.
