...
import { MessageCircle, User, Phone, FileText, UserCheck } from 'lucide-react';
    ...
    >
        ...
        <Card className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950/20 dark:to-emerald-950/20 border-green-200 dark:border-green-800">
          <CardContent className="p-6 space-y-4">
            ...
            {patientData.nome_responsavel && (
              <div className="flex items-center space-x-3 pl-4 border-l-2 border-green-200 dark:border-green-800">
                <div className="w-8 h-8 bg-blue-100 dark:bg-blue-900/30 rounded-full flex items-center justify-center">
                  <UserCheck className="w-4 h-4 text-blue-600 dark:text-blue-400" />
                </div>
                <div>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Responsável</p>
      ...
      <motion.div variants={itemVariants}>
        <Button
          onClick={onConfirm}
          disabled={isLoading}
          className="w-full h-14 text-lg bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 shadow-lg shadow-green-500/25 dark:shadow-green-500/10"
        >
          {isLoading ? (
            <>
      ...
      <motion.div variants={itemVariants} className="text-center">
        <p className="text-sm text-gray-500 dark:text-gray-400">
          Seus dados estão seguros e são utilizados apenas para melhorar sua experiência de cuidado.
        </p>
      </motion.div>
    </motion.div>
  );
